function string = GetEchoStringen(windowPtr, msg, x, y, textColor, bgColor, useKbCheck, varargin)
...
while true
    ...
    output = [msg, ' ', string];
    %Screen('DrawFormattedText', windowPtr, output, x, y, textColor);
    DrawFormattedText(windowPtr, string,'center','center');
